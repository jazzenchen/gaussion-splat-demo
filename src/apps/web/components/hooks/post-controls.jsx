...
export const usePostControls = () => {
  ...
  const bloom = useControls(
    ...
    {
      enabled: true,
      intensity: { min: 0, max: 0.1, step: 0.001, value: 0.07 },
  ...
  const grading = useControls(
    "Grading",
    {
      ...
      contrast: { min: 0.5, max: 1.5, step: 0.001, value: 1.36 },
  ...
  // toneMapping is now handled by CameraComponent, not Scene
  // It will be passed through the rendering object to CameraFrame script
